...
// authorizeRoutingProbation gates both ends of confirm-or-revert the way the
// update itself is gated: whoever may change the routing is who may vouch for a
// change or take it back.
