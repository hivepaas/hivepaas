...
type VolumeServiceClient interface {
	RemoveVolume(ctx context.Context, in *RemoveVolumeReq, opts ...grpc.CallOption) (*RemoveVolumeResp, error)
}
...
func (c *volumeServiceClient) RemoveVolume(ctx context.Context, in *RemoveVolumeReq, opts ...grpc.CallOption) (*RemoveVolumeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveVolumeResp)
...
type VolumeServiceServer interface {
	RemoveVolume(context.Context, *RemoveVolumeReq) (*RemoveVolumeResp, error)
...
func (UnimplementedVolumeServiceServer) RemoveVolume(context.Context, *RemoveVolumeReq) (*RemoveVolumeResp, error) {
