...
func (uc *UC) ListProjectBase(
	ctx context.Context,
	auth *basedto.Auth,
	req *projectsettingsdto.ListProjectBaseReq,
) (*projectsettingsdto.ListProjectBaseResp, error) {
	...
	return &projectsettingsdto.ListProjectBaseResp{
		Meta: &basedto.ListMeta{Page: pagingMeta},
		Data: projectsettingsdto.TransformProjectsBase(projects),
	}, nil
}
