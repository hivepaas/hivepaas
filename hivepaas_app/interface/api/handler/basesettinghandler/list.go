...
func (h *Handler) ListSetting(
	...
	case base.ObjectScopeProjectEnv:
		auth, scope.ProjectID, scope.ProjectEnvID, _, err = h.GetAuthProjectEnvSettings(ctx, base.ActionTypeRead, "")
	case base.ObjectScopeApp:
		auth, scope.ProjectID, scope.ProjectEnvID, scope.AppID, _, err = h.GetAuthAppSettings(ctx, base.ActionTypeRead, "")
	...
	case base.ResourceTypeBackupRepo:
		r := backuprepodto.NewListBackupRepoReq()
		r.Scope = scope
		req, ucFunc = r, func() (any, error) { return h.BackupRepoUC.ListBackupRepo(reqCtx, auth, r) }
	...
	case base.ResourceTypeCommandPipe:
		r := commandpipedto.NewListCommandPipeReq()
		r.Scope = scope
		req, ucFunc = r, func() (any, error) { return h.CommandPipeUC.ListCommandPipe(reqCtx, auth, r) }

	case base.ResourceTypeCommandTemplate:
		r := commandtemplatedto.NewListCommandTemplateReq()
		r.Scope = scope
		req, ucFunc = r, func() (any, error) { return h.CommandTemplateUC.ListCommandTemplate(reqCtx, auth, r) }
	...
	case base.ResourceTypePeriodicJob:
		r := periodicjobdto.NewListPeriodicJobReq()
		r.Scope = scope
		req, ucFunc = r, func() (any, error) { return h.PeriodicJobUC.ListPeriodicJob(reqCtx, auth, r) }
