...
// @Router  /projects/{projectID}/{projectEnv}/access-tokens [get]
func (h *Handler) ListAccessToken(ctx *gin.Context) {
	h.ListSetting(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/access-tokens/{itemID} [get]
func (h *Handler) GetAccessToken(ctx *gin.Context) {
	h.GetSetting(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/access-tokens [post]
func (h *Handler) CreateAccessToken(ctx *gin.Context) {
	h.CreateSetting(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/access-tokens/{itemID} [put]
func (h *Handler) UpdateAccessToken(ctx *gin.Context) {
	h.UpdateSetting(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/access-tokens/{itemID}/status [put]
func (h *Handler) UpdateAccessTokenStatus(ctx *gin.Context) {
	h.UpdateSettingStatus(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/access-tokens/{itemID} [delete]
func (h *Handler) DeleteAccessToken(ctx *gin.Context) {
	h.DeleteSetting(ctx, base.ResourceTypeAccessToken, base.ObjectScopeProjectEnv)
}
