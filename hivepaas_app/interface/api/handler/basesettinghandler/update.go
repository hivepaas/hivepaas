...
func (h *Handler) UpdateSetting(
	...
	case base.ResourceTypeClusterNetwork:
		r := networkdto.NewUpdateNetworkReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.ClusterNetworkUC.UpdateNetwork(reqCtx, auth, r) }

	case base.ResourceTypeClusterNode:
		r := nodedto.NewUpdateNodeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.ClusterNodeUC.UpdateNode(reqCtx, auth, r) }
	...
	case base.ResourceTypeCommandPipe:
		r := commandpipedto.NewUpdateCommandPipeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.CommandPipeUC.UpdateCommandPipe(reqCtx, auth, r) }
	...
	case base.ResourceTypePeriodicJob:
		r := periodicjobdto.NewUpdatePeriodicJobReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.PeriodicJobUC.UpdatePeriodicJob(reqCtx, auth, r) }
