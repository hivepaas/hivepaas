...
func (uc *UC) CreateProject(
	ctx context.Context,
	auth *basedto.Auth,
	req *projectsettingsdto.CreateProjectReq,
) (*projectsettingsdto.CreateProjectResp, error) {
	...
	return &projectsettingsdto.CreateProjectResp{
...
func (uc *UC) preparePersistingProjectBase(
	project *entity.Project,
	req *projectsettingsdto.ProjectBaseReq,
	timeNow time.Time,
	persistingData *persistingProjectData,
) {
