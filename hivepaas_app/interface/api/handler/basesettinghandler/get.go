...
func (h *Handler) GetSetting(
	...
	case base.ResourceTypeBackupRepo:
		r := backuprepodto.NewGetBackupRepoReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.BackupRepoUC.GetBackupRepo(reqCtx, auth, r) }
	...
	case base.ResourceTypeClusterNode:
		r := nodedto.NewGetNodeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.ClusterNodeUC.GetNode(reqCtx, auth, r) }

	case base.ResourceTypeClusterVolume:
		r := volumedto.NewGetVolumeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.ClusterVolumeUC.GetVolume(reqCtx, auth, r) }

	case base.ResourceTypeCommandPipe:
		r := commandpipedto.NewGetCommandPipeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.CommandPipeUC.GetCommandPipe(reqCtx, auth, r) }

	case base.ResourceTypeCommandTemplate:
		r := commandtemplatedto.NewGetCommandTemplateReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.CommandTemplateUC.GetCommandTemplate(reqCtx, auth, r) }
	...
	case base.ResourceTypePeriodicJob:
		r := periodicjobdto.NewGetPeriodicJobReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.PeriodicJobUC.GetPeriodicJob(reqCtx, auth, r) }
