...
func (h *Handler) DeleteSetting(
	...
	case base.ResourceTypeBackupRepo:
		r := backuprepodto.NewDeleteBackupRepoReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.BackupRepoUC.DeleteBackupRepo(reqCtx, auth, r) }
	...
	case base.ResourceTypeCommandPipe:
		r := commandpipedto.NewDeleteCommandPipeReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.CommandPipeUC.DeleteCommandPipe(reqCtx, auth, r) }
	...
	case base.ResourceTypePeriodicJob:
		r := periodicjobdto.NewDeletePeriodicJobReq()
		r.Scope, r.ID = scope, itemID
		req, ucFunc = r, func() (any, error) { return h.PeriodicJobUC.DeletePeriodicJob(reqCtx, auth, r) }
