...
func (h *SystemSettingsHandler) GetSSLRenewalSettings(ctx *gin.Context) {
...
func (h *SystemSettingsHandler) UpdateSSLRenewalSettings(ctx *gin.Context) {
	auth, err := h.AuthHandler.GetCurrentAuth(ctx, &permission.AccessCheck{
		ResourceModule: base.ResourceModuleSystem,
		ResourceType:   base.ResourceTypeSSLRenewal,
...
func (h *SystemSettingsHandler) ExecuteSSLRenewal(ctx *gin.Context) {
	auth, err := h.AuthHandler.GetCurrentAuth(ctx, &permission.AccessCheck{
		ResourceModule: base.ResourceModuleSystem,
		ResourceType:   base.ResourceTypeSSLRenewal,
		Action:         base.ActionTypeWrite,
