...
type Service interface {
	...
	RemoveSecretForApp(ctx context.Context, db database.IDB, app *entity.App, secrets ...*entity.Secret) error
	...
	RemoveConfigForApp(ctx context.Context, db database.IDB, app *entity.App, configs ...*entity.ConfigFile) error
