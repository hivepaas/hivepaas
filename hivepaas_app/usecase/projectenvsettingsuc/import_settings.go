...
func (uc *UC) ImportSettingsToProjectEnv(
	ctx context.Context,
	auth *basedto.Auth,
	req *projectenvsettingsdto.ImportSettingsToProjectEnvReq,
) (*projectenvsettingsdto.ImportSettingsToProjectEnvResp, error) {
	err := transaction.Execute(ctx, uc.db, func(db database.Tx) error {
		...
		return uc.recordProjectEnvUpdate(ctx, db, auth, data.ProjectEnv,
	...
	return &projectenvsettingsdto.ImportSettingsToProjectEnvResp{}, nil
}
