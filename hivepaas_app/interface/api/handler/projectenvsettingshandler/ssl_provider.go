...
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers [get]
func (h *Handler) ListSSLProvider(ctx *gin.Context) {
	h.ListSetting(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers/{itemID} [get]
func (h *Handler) GetSSLProvider(ctx *gin.Context) {
	h.GetSetting(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers [post]
func (h *Handler) CreateSSLProvider(ctx *gin.Context) {
	h.CreateSetting(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers/{itemID} [put]
func (h *Handler) UpdateSSLProvider(ctx *gin.Context) {
	h.UpdateSetting(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers/{itemID}/status [put]
func (h *Handler) UpdateSSLProviderStatus(ctx *gin.Context) {
	h.UpdateSettingStatus(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
...
// @Failure 400 {object} apperrors.ErrorInfo
// @Failure 500 {object} apperrors.ErrorInfo
// @Router  /projects/{projectID}/{projectEnv}/ssl-providers/{itemID} [delete]
func (h *Handler) DeleteSSLProvider(ctx *gin.Context) {
	h.DeleteSetting(ctx, base.ResourceTypeSSLProvider, base.ObjectScopeProjectEnv)
}
