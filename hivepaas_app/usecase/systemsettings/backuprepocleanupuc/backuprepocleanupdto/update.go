...
type UpdateBackupRepoCleanupReq struct {
	settings.UpdateUniqueSettingReq
	*BackupRepoCleanupBaseReq
}

type BackupRepoCleanupBaseReq struct {
	Status       base.SettingStatus                `json:"status"`
	Schedule     ScheduleReq                       `json:"schedule"`
	Notification *basedto.BaseEventNotificationReq `json:"notification"`
}

func (req *BackupRepoCleanupBaseReq) ToEntity() *entity.BackupRepoCleanup {
	return &entity.BackupRepoCleanup{
		Schedule:     req.Schedule.ToEntity(),
		Notification: req.Notification.ToEntity(),
	}
}

func (req *BackupRepoCleanupBaseReq) validate(field string) (res []vld.Validator) {
	if field != "" {
		field += "."
	}
...
func NewUpdateBackupRepoCleanupReq() *UpdateBackupRepoCleanupReq {
	return &UpdateBackupRepoCleanupReq{}
}

func (req *UpdateBackupRepoCleanupReq) ModifyRequest() error {
...
func (req *UpdateBackupRepoCleanupReq) Validate() hperrors.ValidationErrors {
	validators := make([]vld.Validator, 0, 10) //nolint:mnd
	validators = append(validators, req.validate("")...)
	return hperrors.NewValidationErrors(vld.Validate(validators...))
}

type UpdateBackupRepoCleanupResp struct {
