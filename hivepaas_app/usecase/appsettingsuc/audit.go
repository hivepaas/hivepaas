...
// parseAppSetting is a settings row in its typed form, or nil if it cannot be
// read. Unreadable data costs the field list, not the entry.
func parseAppSetting(setting *entity.Setting) entity.SettingData {
	if setting == nil {
		return nil
	}
