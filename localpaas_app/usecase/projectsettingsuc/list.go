...
func (uc *UC) ListProject(
	ctx context.Context,
	auth *basedto.Auth,
	req *projectsettingsdto.ListProjectReq,
) (*projectsettingsdto.ListProjectResp, error) {
	...
	resp, err := projectsettingsdto.TransformProjects(projects)
	if err != nil {
		return nil, apperrors.Wrap(err)
	}

	return &projectsettingsdto.ListProjectResp{
